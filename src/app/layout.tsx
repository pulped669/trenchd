      ...
      <body>
        ...
        <div className="border-t border-border">
          <div className="mx-auto max-w-[1120px] px-5 py-16 text-center">
            <p className="text-[20px] font-extrabold tracking-[-0.02em] text-fg">Stay ahead of the market</p>
            <p className="mt-1.5 text-[14px] text-fg-secondary">Top crypto stories delivered daily. No spam, ever.</p>
            <form className="mx-auto mt-6 flex max-w-[380px] gap-2.5">
              ...
              />
              <button className="shrink-0 rounded-[10px] bg-accent px-6 py-3 text-[13px] font-bold text-white transition-all duration-200 hover:bg-accent-light hover:shadow-md hover:shadow-accent/15 active:scale-[0.97]">
                Subscribe
              </button>
            </form>
          </div>
        ...
        <footer className="border-t border-border">
          <div className="mx-auto max-w-[1120px] px-5 py-10">
            <div className="flex flex-col gap-10 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <p className="text-[16px] font-extrabold tracking-[-0.03em] text-fg">trenchd</p>
                <p className="mt-2 max-w-[260px] text-[13px] leading-[1.65] text-fg-muted">
